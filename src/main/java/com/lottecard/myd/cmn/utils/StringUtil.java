...
public class StringUtil extends StringUtils {
	   private static final Logger logger = LoggerFactory.getLogger(StringUtil.class);
	    ...
	    public static String makeRandomDigit() {
	        ...
	        try {
	            ...
	            for (int i = 0; i < retChar.length; i++) {
	                double randomDigit = Math.random() * 25.0 % 25.0;
	                retChar[i] = (char) (randomDigit + 65);
	                if (retChar[i] < 'A' || retChar[i] > 'Z') {
	    ...
	    public static String  vo2String(Object vo, ToStringStyle style){
			return ToStringBuilder.reflectionToString(vo, style);
		}

		public static String  vo2String(Object vo){
			return vo2String(vo, ToStringStyle.DEFAULT_STYLE);
		}

		public static String  vo2StringWithMultiLineStyle(Object vo){

			return vo2String(vo, ToStringStyle.MULTI_LINE_STYLE);
		}

		public static String  vo2StringWithNoFieldNamesStyle(Object vo){
			return vo2String(vo, ToStringStyle.NO_FIELD_NAMES_STYLE);
		}

		public static String  vo2StringWithSimpleStyle(Object vo){
			return vo2String(vo, ToStringStyle.SIMPLE_STYLE);
		}

		public static String  vo2StringWithShortPrefixStyle(Object vo){
			return vo2String(vo, ToStringStyle.SHORT_PREFIX_STYLE);
		}
		...
		public static String vo2JsonStringWithoutAssignParameters(List<?> list) throws JSONException{
			JSONArray jsonArray = new JSONArray(list);
			for(int i = 0; i < jsonArray.length(); i++){
				jsonArray.getJSONObject(i).remove("assignParameters");
			}
			return jsonArray.toString();
		}

		public static String vo2JsonStringWithoutParameters(List<?> list, String...exceptionKeys) throws JSONException{
			JSONArray jsonArray = new JSONArray(list);
			for(int i = 0; i < jsonArray.length(); i++){
				for(String exceptionKey: exceptionKeys){
					jsonArray.getJSONObject(i).remove(exceptionKey);
				}
			}
			return jsonArray.toString();
		}
//		public static String vo2JsonStringWithoutParameters(Object vo, String...exceptionKeys){
//			JSONObject jsonObject = new JSONObject(vo);
//			for(String exceptionKey: exceptionKeys){
//				jsonObject.remove(exceptionKey);
//			}
//			return jsonObject.toString();
//		}
//
//		public static String vo2JsonStringWithoutAssignParameters(Object vo){
//			JSONObject jsonObject = new JSONObject(vo);
//			jsonObject.remove("assignParameters");
//			return jsonObject.toString();
//		}

		public static List<String> stringTokenizer2List(String str, String delim){
		...
		public static boolean listContainsOnlySpecifiedValues(List<String> lst, boolean isIgnoreCase, String...values){
			boolean result = true;
			for(String listStr: lst){
				boolean singleCheck = false;
				for(String value: values){
					if(isIgnoreCase) {
						if(listStr.equalsIgnoreCase(value)){
							singleCheck = true;
							break;
						}
					} else {
						if(listStr.equals(value)){
							singleCheck = true;
							break;
						}
					}
		...
		public static String subStringWithLength(String str, int length){
